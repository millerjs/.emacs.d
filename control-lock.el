x;;; control-lock.el --- Like caps-lock, but for your control key.  Give your pinky a rest!
...
(control-lock-map-key "," "M-," "comma")
(control-lock-map-key "`" "M-`" "backtick")
(control-lock-map-key "\\t" "M-<tab>" "tab")
(control-lock-map-key "/" "M-/" "slash")
(control-lock-map-key " " "M-@" "space")
(control-lock-map-key "[" "M-[" "lsqrbracket")
(control-lock-map-key "\\\\" "M-\\\\" "backslash")
(control-lock-map-key ";" "M-;" "semicolon")
(control-lock-map-key "." "M-." "period")
(control-lock-map-key "=" "M-=" "equals")
(control-lock-map-key "-" "M--" "dash")

;; Uncomment to remap <return>.  Useful for Proof General.
;; (control-lock-map-key "\\r" "M-<return>" "return")


(defun control-lock-keys ()
  "Sets default keys - C-z enables control lock."
  (global-set-key (kbd "C-d") 'control-lock-enable)
